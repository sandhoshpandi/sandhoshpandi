...
public class DistProdController {
	...
	//Mahalakshmi
	@GetMapping(value = "/viewphmanufacture/{distributorid}")
	public ResponseEntity<?> viewphmanufacture(@PathVariable Integer distributorid) {
		return distProdService.viewphmanufacture(distributorid);
	}

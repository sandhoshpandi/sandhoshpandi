...
//	List<Role> findByCompanyid(Integer compid);

//sound
//	List<Role> findByCompanyidAndRolerankingLessThan(Integer compid, Integer roleranking);

//sound
	List findByCompanyid(Integer compid);

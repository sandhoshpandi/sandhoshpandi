...
public class DistProdService {
	...
	//Mahalakshmi
	public ResponseEntity<?> viewphmanufacture(Integer distributorid) {
		List dp = distProdRepo.findBydistributorid(distributorid);
		return ResponseEntity.created(null).body(dp);
	}

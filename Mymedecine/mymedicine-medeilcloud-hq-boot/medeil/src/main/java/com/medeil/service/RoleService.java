...
public class RoleService {
	...
	public ResponseEntity<?> getSingleRoleDetail(Integer roleid) {
		Role ro=roleRepository.findById(roleid);
		return ResponseEntity.created(null).body(ro);
	}

	public ResponseEntity<Boolean> editRoledetails(Integer roleid,Integer roleranking) {
		Role ro=roleRepository.findById(roleid);
		ro.setRoleranking(roleranking);

...
public class RoleController {
	...
	//sound
	//get individual role based details using roleid
	@GetMapping(value = "getSingleRoleDetail/{roleid}")
	public ResponseEntity<?> getSingleRoleDetail(@PathVariable Integer roleid){
		return roleService.getSingleRoleDetail(roleid);
	}
	
	//sound
	//edit individual role ranking details based roleid
	@GetMapping(value = "/editRoledetails/{roleid}/{roleranking}")
	public ResponseEntity<Boolean> editRoledetails(@PathVariable Integer roleid,@PathVariable Integer roleranking) throws Exception {
		return roleService.editRoledetails(roleid,roleranking);
	}
}

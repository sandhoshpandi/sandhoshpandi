...
//	 get Employee's Branch
	...
	//sound
	@GetMapping(value = "/getroledetails/{compid}")
	public List getRoleDetails(@PathVariable Integer compid) throws Exception {
		return employeeServices.getRoleDetails(compid);
	}

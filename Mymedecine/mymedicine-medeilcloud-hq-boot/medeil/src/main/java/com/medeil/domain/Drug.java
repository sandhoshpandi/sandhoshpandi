...
public class Drug implements Serializable {
	...
	private String dosageenglish;
	
	private String dosageburmese;
	private String packagesizeenglish;
	
	private String packagesizeburmese;
	private String  sellingunitenglish;
	private String  sellingunitburmese;
	...
	public String getDosageenglish() {
		return dosageenglish;
	}

	public void setDosageenglish(String dosageenglish) {
		this.dosageenglish = dosageenglish;
	}

	public String getDosageburmese() {
		return dosageburmese;
	}

	public void setDosageburmese(String dosageburmese) {
		this.dosageburmese = dosageburmese;
	}

	public String getPackagesizeenglish() {
		return packagesizeenglish;
	}

	public void setPackagesizeenglish(String packagesizeenglish) {
		this.packagesizeenglish = packagesizeenglish;
	}

	public String getPackagesizeburmese() {
		return packagesizeburmese;
	}

	public void setPackagesizeburmese(String packagesizeburmese) {
		this.packagesizeburmese = packagesizeburmese;
	}

	public String getSellingunitenglish() {
		return sellingunitenglish;
	}

	public void setSellingunitenglish(String sellingunitenglish) {
		this.sellingunitenglish = sellingunitenglish;
	}

	public String getSellingunitburmese() {
		return sellingunitburmese;
	}

	public void setSellingunitburmese(String sellingunitburmese) {
		this.sellingunitburmese = sellingunitburmese;
	}

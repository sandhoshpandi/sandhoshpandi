...
//server old
	...
	@Query(value="SELECT pr.brandname,dcp.batchname,dcp.boxqty,dcp.productname,dcp.productcode,dcp.stripperbox,dcp.totalqty,dcp.packageunit,dcp.drugproductrefid FROM medc_stock.medc_dchallanproduct dcp\r\n" + 
